...
public class Database {
	...
	public String showDatabaseEntries() {
		...
		try {
			...
			while(rs.next()) {
				sb.append(rs.getString("Respondents.NAME") + " " + rs.getString("Project.projectName") + " " + rs.getString("Project.projectClient") + " " + rs.getString("Answers.FirstAnswer") + " " + rs.getString("Answers.SecondAnswer") + " " + rs.getString("Answers.ThirdAnswer") + " " + rs.getString("Answers.FourthAnswer") + "<br>");
			}
		} catch (SQLException e) {
			System.out.println(e);
		}
